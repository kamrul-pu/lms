                ...
                <div class="container py-4">
                    <div class="row g-5 ps-5">
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Bonani, Dhaka, Bangladesh</p>
                            <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+8801981234567</p>
                            <p class="mb-2"><i class="fa fa-envelope me-3"></i>learning.edu007@example.com</p>
