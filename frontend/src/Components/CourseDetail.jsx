...
const CourseDetail = () => {
    ...
    try {
      axios.get(baseUrl + course_slug, {
        ...
        .then((res) => {
          ...
          // setTeacherData(res.data.instructor)
          setCourseData(res.data);
          setEnrolledStatus(res.data.is_enrolled);
      ...
      //   axios.get(baseUrl + '/update-view/' + course_slug)
      //     .then((res) => {
      ...
      // }
      // try {
      //   axios.get(baseUrl + '/fetch-enroll-status/' + studentId + '/' + course_slug)
      //     .then((res) => {
      ...
      // try {
      //   axios.get(baseUrl + '/fetch-rating-status/' + studentId + '/' + course_slug)
      //     .then((res) => {
      //       if (res.data.bool == true) {
      ...
      // try {
      //   axios.get(baseUrl + '/fetch-favorite-status/' + studentId + '/' + course_slug)
      //     .then((res) => {
      //       if (res.data.bool == true) {
  ...
  const enrollCourse = () => {
    ...
    try {
      axios.post("http://127.0.0.1:8000/api/v1/courses/enrollments", _formData, {
        headers: {
  ...
  // const formSubmit = () => {
  //   const _formData = new FormData();
  //   _formData.append('course', course_slug);
  //   _formData.append('student', studentId);
  ...
  //   try {
  //     axios.get(baseUrl + '/student-remove-favorite-course/' + course_slug + '/' + studentId, {
  //       headers: {
  //         'content-type': 'multipart/form-data'
  //       }
  //     })
    ...
    <div className='conatiner mt-4 px-4 hod'>
      <div className='row'>
        <div class="col-lg-3 col-md-6 mt-3">
          <div class="team-item bg-light">
            <div class="overflow-hidden">
              <img src={courseData.image} className="card-img-top img-fluid img-thumbnail" alt={courseData.title} />
            </div>
          </div>
        </div>
        <div className='col-8 pd-2 mt-3'>
          ...
          <h5>Enrolled: {courseData.is_enrolled}</h5>
          ...
          {courseData && courseData.instructor && (
            <p className='fw-bold'>Course By : <Link to={`/teacher-detail/${courseData.instructor.id}`}>{courseData.instructor.first_name + " " + courseData.instructor.last_name}</Link></p>
          )}
